...
modifier_greevil_status_resist = class({})

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:IsPurgeException()
	return true
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:IsHidden()
	return false
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:GetPriority()
	return MODIFIER_PRIORITY_ULTRA + 10000
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:OnCreated( kv )
	...
	--printf( "modifier_greevil_status_resist:OnCreated - stack count: %d", self:GetStackCount() )
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:OnRefresh( kv )
	--self:IncrementStackCount()
end

--------------------------------------------------------------------------------

function modifier_greevil_status_resist:OnStackCountChanged( nOldCount )
	--printf( "-----------------" )
	--printf( "modifier_greevil_status_resist:OnStackCountChanged" )
...
--[[
function modifier_greevil_status_resist:DeclareFunctions()
	local funcs = {
...
--[[
function modifier_greevil_status_resist:GetModifierStatusResistanceStacking( params )
