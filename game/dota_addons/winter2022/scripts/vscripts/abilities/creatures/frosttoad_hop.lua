...
frosttoad_hop = class({})
LinkLuaModifier( "modifier_frosttoad_hop", "modifiers/creatures/modifier_frosttoad_hop", LUA_MODIFIER_MOTION_BOTH )

----------------------------------------------------------------------------------------

function frosttoad_hop:Precache( context )
...
function frosttoad_hop:ProcsMagicStick()
	return false
end

--------------------------------------------------------------------------------

function frosttoad_hop:OnAbilityPhaseStart()
	if IsServer() then
...
function frosttoad_hop:OnAbilityPhaseInterrupted()
	if IsServer() then
...
function frosttoad_hop:OnSpellStart()
	if IsServer() then
		self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_frosttoad_hop", {} )
...
function frosttoad_hop:TryToDamage()
	if IsServer() then
