...
modifier_jungle_spirit_ground_pound_thinker = class({})

--------------------------------------------------------------------------------

function modifier_jungle_spirit_ground_pound_thinker:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_jungle_spirit_ground_pound_thinker:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_jungle_spirit_ground_pound_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_jungle_spirit_ground_pound_thinker:OnIntervalThink()
	if IsServer() then
