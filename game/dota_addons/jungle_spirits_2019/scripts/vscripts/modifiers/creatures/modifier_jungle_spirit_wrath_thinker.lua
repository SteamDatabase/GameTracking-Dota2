...
modifier_jungle_spirit_wrath_thinker = class({})

-----------------------------------------------------------------------------

function modifier_jungle_spirit_wrath_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_jungle_spirit_wrath_thinker:OnIntervalThink()
	if IsServer() then
