...
function modifier_sand_king_boss_passive:GetModifierFixedAttackRate( params )
	return 1
end
...
function modifier_sand_king_boss_passive:GetModifierMoveSpeed_Absolute( params )
	return 450
end
