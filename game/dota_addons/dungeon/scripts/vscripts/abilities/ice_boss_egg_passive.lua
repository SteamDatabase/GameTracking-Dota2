...
LinkLuaModifier( "modifier_ice_boss_egg_passive", "modifiers/modifier_ice_boss_egg_passive", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ice_boss_egg_curse_marker", "modifiers/modifier_ice_boss_egg_curse_marker", LUA_MODIFIER_MOTION_NONE )
