--[[ abilities/stone_boulder.lua ]]

stone_boulder = class({})

--------------------------------------------------------------------------------

function stone_boulder:OnSpellStart()
	--print( "stone_boulder:OnSpellStart()" )
	self.start_radius = self:GetSpecialValueFor( "start_radius" )
	self.end_radius = self:GetSpecialValueFor( "end_radius" )
	self.speed = self:GetSpecialValueFor( "speed" )
	self.stone_damage = self:GetSpecialValueFor( "damage" ) 
...
function stone_boulder:OnProjectileHit( hTarget, vLocation )
	local stoneDamage = self.stone_damage
