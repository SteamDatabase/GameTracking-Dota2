...
centaur_shaman_ranged_attack = class({})

--------------------------------------------------------------------------------

function centaur_shaman_ranged_attack:OnSpellStart()
	if IsServer() then
...
function centaur_shaman_ranged_attack:OnProjectileHit( hTarget, vLocation )
	if IsServer() then
