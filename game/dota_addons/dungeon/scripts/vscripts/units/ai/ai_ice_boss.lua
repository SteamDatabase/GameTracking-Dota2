...
LAND_DURATION = 20.0
EGG_HATCH_TIME = 10.0
HOME_VECTOR = Vector( -2914, 4435, 2304 )


--------------------------------------------------------------------------------
LinkLuaModifier( "modifier_ice_boss_passive", "modifiers/modifier_ice_boss_passive", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ice_boss_trapping_shards", "modifiers/modifier_ice_boss_trapping_shards", LUA_MODIFIER_MOTION_NONE )
