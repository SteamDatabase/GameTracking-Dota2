...
function Spawn( entityKeyValues )
	...
	thisEntity:SetContextThink( "UndeadOgreSealThink", UndeadOgreSealThink, 1 )
end

--------------------------------------------------------------------------------

function UndeadOgreSealThink()
...
function InitUndeadOgreSeal()
	print( "thisEntity.hFlop's level: " .. thisEntity.hFlop:GetLevel() )
	if thisEntity.hFlop and thisEntity.hFlop:GetLevel() ~= 2 then
		hFlop:SetLevel( 2 )
		print( "thisEntity.hFlop level is now: " .. hFlop:GetLevel() )
	end
end
