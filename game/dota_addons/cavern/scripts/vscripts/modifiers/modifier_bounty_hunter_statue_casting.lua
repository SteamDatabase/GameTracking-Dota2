...
modifier_bounty_hunter_statue_casting = class({})

--------------------------------------------------------------------------------

function modifier_bounty_hunter_statue_casting:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_bounty_hunter_statue_casting:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_bounty_hunter_statue_casting:OnCreated( kv )
	if IsServer() then
...
function modifier_bounty_hunter_statue_casting:DeclareFunctions()
	local funcs = {
...
function modifier_bounty_hunter_statue_casting:GetOverrideAnimation( params )
