...
var RunIntroAnimation = function ()
{
    ...
    seq.actions.push( new FireEntityInputAction( scenePanel, 'marci', 'TurnOn', '' ) );
...
var RunOutroAnimation = function ()
{
    ...
    seq.actions.push( new WaitForClassAction( scenePanel, 'SceneLoaded' ) );
    seq.actions.push( new FireEntityInputAction( scenePanel, 'marci', 'TurnOff', '') );
...
var ManuallyTriggerMarciDebut = function()
{
    $.Msg("Marci ManuallyTriggerMarciDebut");
    $.DispatchEvent( "DOTAShowReferencePage", "file://{resources}/layout/leaf_pages/dashboard_page_debut_marci.xml");
    $.DispatchEvent( "DOTADebutMovieFinished");
}