...
function AnimateFall2021WeeklyQuestEntryAction( questList, pipBar, actionGranted )
{
...
AnimateFall2021WeeklyQuestEntryAction.prototype = new BaseAction();

AnimateFall2021WeeklyQuestEntryAction.prototype.start = function()
{
    var questStars = this.entryPanel.FindChildInLayoutFile( 'Fall2021WeeklyQuestStars' );
    var progressBar = this.entryPanel.FindChildInLayoutFile( 'Fall2021WeeklyProgressBar' );
    progressBar.lowervalue = this.actionGranted.progress_start_value;
    ...
    this.seq.actions.push( new AddClassAction( this.entryPanel, 'ShowEntry' ) );
    ...
    for ( var i = 0; i < this.actionGranted.level_thresholds.length; ++i )
    {
        ...
        if ( this.actionGranted.progress_start_value >= levelThreshold.threshold )
         ...
         // Setup threshold
        this.seq.actions.push( new RunFunctionAction( function ( panel, lowerValue, nextThreshold ) { return function()
        {
        ...
        if ( nextAnimateValue == levelThreshold.threshold )
        {
            ...
            this.seq.actions.push( new AddClassAction( tierStar, 'StarAchieved' ) );
            this.seq.actions.push( new PlaySoundAction( 'WeeklyQuest.StarGranted' ) );
            this.seq.actions.push( new RunFunctionAction( function( pipBar ) { return function() {
...
AnimateFall2021WeeklyQuestEntryAction.prototype.update = function()
{
    return this.seq.update();
}

AnimateFall2021WeeklyQuestEntryAction.prototype.finish = function()
{
    this.seq.finish();
}
...
function AnimateFall2021WeeklyQuestsAction( sectionPanel, nEventID, nSeasonID, actionsGranted, nInitialStars )
{
...
AnimateFall2021WeeklyQuestsAction.prototype = new BaseAction();

AnimateFall2021WeeklyQuestsAction.prototype.start = function()
{
    ...
    if ( this.actionsGranted != null )
    {
        ...
        {
            this.seq.actions.push( new AnimateFall2021WeeklyQuestEntryAction( questList, pipBar, this.actionsGranted[ i ] ) );
        }
    }
...
AnimateFall2021WeeklyQuestsAction.prototype.update = function()
{
    return this.seq.update();
}

AnimateFall2021WeeklyQuestsAction.prototype.finish = function()
{
    this.seq.finish();
}
...
function AnimateFall2021EventGameAction( sectionPanel, eventGameData )
{
    this.sectionPanel = sectionPanel;
    this.eventGameData = eventGameData;
}

AnimateFall2021EventGameAction.prototype = new BaseAction();

AnimateFall2021EventGameAction.prototype.start = function()
{
    ...
    this.seq = new RunSequentialActions();
    this.seq.actions.push( new AddClassAction( this.sectionPanel, 'ShowBattlePoints' ) );
    this.seq.actions.push( new WaitAction( 0.2 ) );
    ...
    this.seq.actions.push( parBattlePoints );

    this.seq.actions.push( new WaitAction( 0.2 ) );

    this.seq.actions.push( new AddClassAction( this.sectionPanel, 'ShowFragments' ) );
    this.seq.actions.push( new WaitAction( 0.2 ) );
    ...
    this.seq.actions.push( parFragments );

    this.seq.start();
}

AnimateFall2021EventGameAction.prototype.update = function()
{
    return this.seq.update();
}

AnimateFall2021EventGameAction.prototype.finish = function()
{
    return this.seq.finish();
}
...
function AnimateFall2021CavernCrawlAction( sectionPanel, cavernCrawlData )
{
    this.sectionPanel = sectionPanel;
    this.cavernCrawlData = cavernCrawlData;
}

AnimateFall2021CavernCrawlAction.prototype = new BaseAction();

AnimateFall2021CavernCrawlAction.prototype.start = function()
{
...
AnimateFall2021CavernCrawlAction.prototype.update = function()
{
    return this.seq.update();
}

AnimateFall2021CavernCrawlAction.prototype.finish = function()
{
    return this.seq.finish();
}
...
function AnimateFall2021DrowArcanaMinigameAction( sectionPanel, minigameData )
{
    this.sectionPanel = sectionPanel;
    this.minigameData = minigameData;
}

AnimateFall2021DrowArcanaMinigameAction.prototype = new BaseAction();

AnimateFall2021DrowArcanaMinigameAction.prototype.start = function()
{
    this.sectionPanel.AddClass( 'ShowSection' );
    ...
    this.seq.actions.push( new WaitAction( 0.4 ) );
    this.seq.actions.push( new AddClassAction( this.sectionPanel, 'ShowMysteryBoxIcon' ) );

    this.seq.start();
}

AnimateFall2021DrowArcanaMinigameAction.prototype.update = function()
{
    return this.seq.update();
}

AnimateFall2021DrowArcanaMinigameAction.prototype.finish = function()
{
    return this.seq.finish();
}
...
function AnimateFall2021ScreenAction( data )
{
    this.data = data;
}

AnimateFall2021ScreenAction.prototype = new BaseAction();

AnimateFall2021ScreenAction.prototype.start = function ()
{
    ...
    this.seq.actions.push( new AddScreenLinkAction( panel, 'Fall2021Progress', '#DOTA_BattlePassPostGame_Progress' ) );

    this.seq.actions.push( new SkippableAction( new AnimateFall2021WeeklyQuestsAction( 
    ...
    if ( this.data.fall_2021_progress.event_game_rewards != null )
    {
        ...
        this.seq.actions.push( new SkippableAction( new AnimateFall2021EventGameAction( section, this.data.fall_2021_progress.event_game_rewards ) ) );
        this.seq.actions.push( new SkippableAction( new WaitAction( 0.5 ) ) );
    }
    ...
    if ( this.data.fall_2021_progress.cavern_crawl != null )
    {
        ...
        section.AddClass( 'SectionHasData' );
        this.seq.actions.push( new SkippableAction( new AnimateFall2021CavernCrawlAction( section, this.data.fall_2021_progress.cavern_crawl ) ) );
        this.seq.actions.push( new SkippableAction( new WaitAction( 0.5 ) ) );
    }
    ...
    if ( this.data.fall_2021_progress.drow_arcana_minigame != null )
    {
        ...
        section.AddClass( 'SectionHasData' );
        this.seq.actions.push( new SkippableAction( new AnimateFall2021DrowArcanaMinigameAction( section, this.data.fall_2021_progress.drow_arcana_minigame ) ) );
        this.seq.actions.push( new SkippableAction( new WaitAction( 0.5 ) ) );
    }
...
AnimateFall2021ScreenAction.prototype.update = function ()
{
    return this.seq.update();
}
AnimateFall2021ScreenAction.prototype.finish = function ()
{
    this.seq.finish();
}
