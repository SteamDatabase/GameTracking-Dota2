-- Workshop Importer [animation_ability2_gesture]: Delta Animation (Subtraction)
model:CreateSequence(
	{
		name = "ability2_gesture",
		delta = true,
		fadeInTime = 0,
		fadeOutTime = 0,
		fps = 30,
		framerangesequence = "@ability2_gesture",
		cmds = {
			 { cmd = "sequence", sequence = "@ability2_gesture", dst = 1 },
			 { cmd = "fetchframe", sequence = "@ability2_gesture", frame = 0, dst = 2 },
