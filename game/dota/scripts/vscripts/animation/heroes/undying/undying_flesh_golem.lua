...
model:CreateSequence(
	{
		...
		framerangesequence = "@flesh_golem_cast1_decay",
		cmds = {
			{ cmd = "sequence", sequence = "@flesh_golem_cast1_decay", dst = 1 },
			{ cmd = "fetchframe", sequence = "@flesh_golem_cast1_decay", frame = 0, dst = 2 },
